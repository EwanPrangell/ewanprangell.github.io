public abstract class Main extends TameableEntity implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    private static final TrackedData<Boolean> SLEEPING = DataTracker.registerData(Main.class, TrackedDataHandlerRegistry.BOOLEAN);

    protected Main(EntityType<? extends TameableEntity> entityType, World world) {
