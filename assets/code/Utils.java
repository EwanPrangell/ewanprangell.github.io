public abstract class Utils extends TameableEntity implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    private static final TrackedData<Boolean> SLEEPING = DataTracker.registerData(Utils.class, TrackedDataHandlerRegistry.BOOLEAN);

    protected Utils(EntityType<? extends TameableEntity> entityType, World world) {
